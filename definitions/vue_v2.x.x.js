...
/***** plugin  *****/
declare type Vue$PluginFunction = (Vue: typeof Vue, options?: Object) => void;

declare interface Vue$PluginObject {
...
declare class Vue {
  ...
  static use(plugin: Vue$PluginObject | Vue$PluginFunction, options?: Object): void;
